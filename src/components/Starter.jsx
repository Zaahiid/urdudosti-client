...
const Starter = () => {
  return (
    <div className="text-center ">
      <h4 className="text-7xl font-semibold text-gray-800 mt-20 md:mt-56 lg:mt-32 my-5">
        اردو دوستی
      </h4>
      ...
      <div className="flex items-center justify-center gap-2">
        <IgLogo />
        <h4 className="text-xl font-medium italic text-red-950">
          <a
            href="https://www.instagram.com/urdudosti/"
            target="_blank"
            rel="noreferrer"
          >
            @urdudosti
